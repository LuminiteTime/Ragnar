			...
			<div class="m-auto pb-44 flex flex-col justify-center">
				<div class="max-w-md">
					...
					<div class=" mt-4 text-center text-sm w-full">
						{$i18n.t(
							"Oops! You're using an unsupported method (frontend only). Please serve the Ragnar from the backend."
						)}
						...
						<a
							...
							href="https://gitlab.pg.innopolis.university/m.trifonov/ragnar/-/blob/main/README.md"
